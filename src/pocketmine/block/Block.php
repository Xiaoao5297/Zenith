...
class Block extends Position implements Metadatable{
	...
	const SAPLINGS = 6;
	const BEDROCK = 7;
	const WATER = 8; const FLOWING_WATER = 8;
	const STILL_WATER = 9;
	const LAVA = 10; const FLOWING_LAVA = 10;
	const STILL_LAVA = 11;
	const SAND = 12;
	const GRAVEL = 13;
	const GOLD_ORE = 14;
	...
	const SLABS = 44;
	const BRICKS = 45;
	const BRICKS_BLOCK = 45; const BRICK_BLOCK = 45;
	const TNT = 46;
	const BOOKSHELF = 47;
	const MOSS_STONE = 48;
	...
	const WOOD_STAIRS = 53; const OAK_STAIRS = 53;
	...
	const MONSTER_EGG_BLOCK = 97; const MONSTER_EGG = 97;
	...
	const NETHER_BRICKS_STAIRS = 114; const NETHER_BRICK_STAIRS = 114;
	...
	const SPRUCE_WOOD_STAIRS = 134; const SPRUCE_WOODEN_STAIRS = 134; const SPRUCE_STAIRS = 134;
	const BIRCH_WOOD_STAIRS = 135; const BIRCH_WOODEN_STAIRS = 135; const BIRCH_STAIRS = 135;
	const JUNGLE_WOOD_STAIRS = 136; const JUNGLE_WOODEN_STAIRS = 136; const JUNGLE_STAIRS = 136;
	...
	const TRUNK2 = 162;
	const LOG2 = 162;
	const ACACIA_WOOD_STAIRS = 163; const ACACIA_STAIRS = 163; const ACACIA_WOODEN_STAIRS = 163;
	const DARK_OAK_WOOD_STAIRS = 164; const DARK_OAK_STAIRS = 164; const DARK_OAK_WOODEN_STAIRS = 164;
	...
	const FENCE_GATE_SPRUCE = 183; const SPRUCE_FENCE_GATE = 183;
	const FENCE_GATE_BIRCH = 184; const BIRCH_FENCE_GATE = 184;
	const FENCE_GATE_JUNGLE = 185; const JUNGLE_FENCE_GATE = 185;
	const FENCE_GATE_DARK_OAK = 186; const DARK_OAK_FENCE_GATE = 186;
	const FENCE_GATE_ACACIA = 187; const ACACIA_FENCE_GATE = 187;
	...
	public function getBreakTime(Item $item){
		...
		if($this->canBeBrokenWith($item)){
			...
			$enchantmentLevel = $item->getEnchantmentLevel(15);
			
			if($enchantmentLevel > 0){ //效率

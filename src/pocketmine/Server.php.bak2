...
$this->aboutstring = "\n
§3   ______              _                   
§3  / ____/___   ____   (_)_____ __  __ _____
§3 / / __ / _ \ / __ \ / // ___// / / // ___/
§3/ /_/ //  __// / / // /(__  )/ /_/ /(__  ) 
§3\____/ \___//_/ /_//_//____/ \__, //____/  
§3                            /____/
		   §5PocketMine-iTX §3Genisys §f是PocketMine-MP的分支, 创作者：§5iTX Technologies LLC§f.
		   §f版本: §6" . $this->getPocketMineVersion() . "
		   §f汉化版本§56.0！
		   §f客户端支持版本: §d" . \pocketmine\MINECRAFT_VERSION . "
		   §fhttps://github.com/iTXTech/Genisys上有最新的源代码
		   §f赞助: http://pl.zxda.net/plugins/203.html
		...
		\n";
			...
			$this->logger->info("正在加载 genisys.yml...");
...
private function lookupAddress($address) {
	...
	public function reload(){
		...
		$this->logger->info("正在重载 properties...");

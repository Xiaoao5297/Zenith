...
class MakeServerCommand extends VanillaCommand{
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$pharPath = Server::getInstance()->getPluginPath() . DIRECTORY_SEPARATOR . "SCAXE" . DIRECTORY_SEPARATOR . $server->getName() . "_" . $server->getPocketMineVersion() . ".phar";
		...
		$phar->setMetadata([
			...
			"creator" => "SCAXE MakeServerCommand",
			"creationDate" => time()
		]);
		...
		foreach(new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($filePath . "src")) as $file){
			...
			$sender->sendMessage("[SCAXE] Adding $path");
		}

...
use pocketmine\command\defaults\ConvertCommand;
...
//use pocketmine\command\defaults\EncryptionPluginCommand;
...
class SimpleCommandMap implements CommandMap{
	...
	private function setDefaultCommands(){
		...
		//$this->register("pocketmine", new EncryptionPluginCommand("enp"));
		...
		$this->register("pocketmine", new ConvertCommand("convert"));

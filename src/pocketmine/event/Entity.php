...
abstract class Entity extends Location implements Metadatable{
	...
	const DATA_CREPPER_SWELL = 17; //苦力怕爆炸动画 byte (似乎是控制闪光的)
	const DATA_CREPPER_SWELL_2 = 18; //苦力怕爆炸动画 byte (似乎是控制大小的)
	...
	//46 ????
	const DATA_VILLAGER_IS_BABY= 46; //byte | Mojang你脑子是不是不好使 村民可以用id14的data你非得再整一个?
	//47 ????

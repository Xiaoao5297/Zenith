...
interface Info{
	...
	// 协议版本分组 (参照 lycore 参考核心: 0.11=27,29~33, 0.12=34, 0.13=37~39, 0.14=41~46,60,70)
	const V011_PROTOCOLS = [27, 29, 30, 31, 32, 33];
	const V012_PROTOCOLS = [34];
	const V013_PROTOCOLS = [37, 38, 39];
	const V014_PROTOCOLS = [41, 42, 43, 44, 45, 46, 60, 70];
	const V015_PROTOCOLS = [];
	const ACCEPTED_PROTOCOLS = [27, 29, 30, 31, 32, 33, 34, 37, 38, 39, 41, 42, 43, 44, 45, 46, 60, 70];
